...
def predict(): # this function can have any name
	model = load_model('music_taste_predictor.h5') # the nand.h5 file was created in Colab, downloaded and uploaded using Filezilla
	...
	if in1 == None: 
		...
		arr = np.array([[ str(in1) ]]) # cast string to decimal number, and make 2d numpy array.

        # spotify api in action here =>

        # 1. get search results
        # 2. save the first result
        # 3. clean up the unnecessary data
        # 4. start prediction 
